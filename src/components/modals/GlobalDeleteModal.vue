...
<template>
    <BaseModal :isOpen="modalStore.isDeleteOpen" @close="modalStore.closeDeleteModal" size="sm">
        <template #header>
            <div class="flex items-start gap-4">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-status-danger" fill="none"
        ...
        <template #footer>
            <button type="button"
                class="inline-flex w-full justify-center rounded-lg bg-status-danger px-4 py-2.5 text-sm font-bold text-white shadow-none hover:bg-status-danger/90 focus:outline-none transition-colors duration-200 sm:ml-3 sm:w-auto disabled:opacity-70 disabled:cursor-not-allowed"
