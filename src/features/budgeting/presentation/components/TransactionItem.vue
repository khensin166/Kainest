...
<template>
  <div class="bg-surface-card rounded-xl border border-border-default p-4 transition-all">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-start overflow-hidden">
        ...
        <div class="truncate">
          ...
          <p v-if="transaction.note && transaction.note !== '-'" class="text-sm text-text-muted italic mt-1 truncate">
            "{{ transaction.note }}"
          </p>
        </div>
      </div>
