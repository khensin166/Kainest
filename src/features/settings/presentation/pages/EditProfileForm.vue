        ...
        <div class="space-y-4 pt-2 pb-2">
          ...
          <div class="flex gap-3 p-3 bg-violet-50 dark:bg-violet-900/20 rounded-xl border border-violet-100 dark:border-violet-800 text-left">
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Ketik perintah ini ke chat bot WhatsApp</p>
          ...
          <div class="flex gap-3 text-left">
            ...
            <div>
              <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Buka chat personal bot</p>
              <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">Kirimkan kode di atas ke chat bot, lalu buat grup baru bersamanya.</p>
          ...
          <div class="flex gap-3 text-left">
            ...
            <div>
              <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Buat grup baru bersama bot</p>
              <div class="mt-1.5 space-y-1.5">
                <div class="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                  <span class="text-base leading-none">🤖</span>
                  <p><span class="font-medium text-gray-700 dark:text-gray-300">Android:</span> Ketuk ikon titik tiga (⋮) di pojok kanan atas → pilih <em>New Group</em></p>
                </div>
                <div class="flex items-start gap-2 text-xs text-gray-600 dark:text-gray-400">
                  <span class="text-base leading-none">🍎</span>
                  <p><span class="font-medium text-gray-700 dark:text-gray-300">iPhone:</span> Ketuk nama profil bot di atas → pilih <em>Create Group with...</em></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="flex gap-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800 text-left">
            ...
            <div>
              <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Aktifkan grup bertransaksi</p>
              <p class="text-xs text-gray-500 dark:text-gray-400 mb-1.5">Di dalam grup tersebut, ketik perintah ini:</p>
