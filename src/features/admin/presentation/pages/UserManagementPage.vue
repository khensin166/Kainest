<template>
  <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700 p-6">
      ...
      <!-- Error State -->
      <div v-else-if="error" class="p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-lg text-sm flex items-center gap-3">
        ...
        >
          ...
          <div class="flex flex-col sm:flex-row sm:items-center gap-4">
            ...
            <div class="flex items-center gap-4 flex-1 min-w-0">
              <img 
                class="h-10 w-10 rounded-full object-cover flex-shrink-0 shadow-sm" 
            ...
            <div class="flex items-center gap-3 self-end sm:self-auto">
              ...
              <select 
                ...
                class="text-sm border border-gray-300 dark:border-gray-600 rounded-md px-3 py-1.5 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer"
              >
              ...
              <button 
                ...
                class="inline-flex items-center px-4 py-1.5 text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition-colors"
              >
              ...
              <div v-else class="flex items-center px-2 py-1.5 text-sm text-gray-400 dark:text-gray-500">
          ...
          <div class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="flex flex-wrap gap-x-6 gap-y-2">
              ...
              >
                ...
                >
                <span class="text-sm text-gray-700 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors select-none">
                  {{ mod.label }}
                </span>
              </label>
            </div>
