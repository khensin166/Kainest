...
10. **Pemisahan Keywords Kantong per User**: Memindahkan logic penyimpanan `keywords` AI dari tabel global `BudgetCategory` ke dalam tabel privat `BudgetPocket` agar setiap pengguna dapat mengkustomisasi kata kunci tanpa mengubah settingan pengguna lain yang menggunakan kategori default yang sama. (Lihat implementation_plan.md)
